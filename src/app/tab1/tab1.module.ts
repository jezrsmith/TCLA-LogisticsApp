...
@NgModule({
  ...
  declarations: [Tab1Page, PhotoPage, BarcodePage, QrcodePage, DatafieldsPage, HeaderPage, CreateflowComponent],
  entryComponents: [PhotoPage, BarcodePage, QrcodePage, DatafieldsPage, HeaderPage, CreateflowComponent]
})
